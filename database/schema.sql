...
CREATE TABLE bookings (
    ...
    rental_mode       VARCHAR(50)     NOT NULL DEFAULT 'DAILY',
    pricing_package   VARCHAR(100)    NULL,
    delivery_method   VARCHAR(50)     NOT NULL DEFAULT 'SHOWROOM',
    delivery_address  NVARCHAR(500)   NULL,
    delivery_distance DECIMAL(18,2)   NULL,
    delivery_fee      DECIMAL(18,2)   NOT NULL DEFAULT 0,
    km_limit          INT             NULL,
    estimated_km      INT             NULL,
