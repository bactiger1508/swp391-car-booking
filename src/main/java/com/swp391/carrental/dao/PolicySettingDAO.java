...
public class PolicySettingDAO {
    ...
    // Retrieve policy settings by category
    ...
    // Update existing policy or create a new one if not found
    ...
    public int batchUpdateValues(Map<String, String> updates, int updatedBy) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection()) {
            ...
            try (PreparedStatement selectPs = conn.prepareStatement(selectSql); PreparedStatement updatePs = conn.prepareStatement(updateSql); PreparedStatement insertPs = conn.prepareStatement(insertSql)) {

                // Process each policy update
    ...
    // Get discription for policy key
