                    ...
                    <div class="print-page">
                        ...
                        <div class="party-info">
                            ...
                            <table class="party-table">
                                <tr>
                                    <td colspan="2">Công ty: <strong>${companyName}</strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">Đại diện ký kết: <strong>${creator != null ? creator.fullName : '........................'}</strong></td>
                                </tr>
                            </table>
                    ...
                    <div class="print-page">
                        ...
                        <div class="signature-block" style="margin-top: 30px;">
                            <table style="width: 100%; border: none; text-align: center; font-size: 11pt;">
                                        ...
                                        <c:choose>
                                            <c:when test="${contract.staffSigned}">
                                                <div style="border: 1.5px dashed green; color: green; width: 230px; margin: 0 auto; padding: 8px; border-radius: 4px; font-weight: bold; font-family: monospace; font-size: 8.5pt; background: #f9fff9; text-align: center; line-height: 1.4;">
                                                    ...
                                                    <br/>
                                                    <span style="font-size: 7.5pt; font-weight: normal; color: #666;">Bên A: ${companyName}</span>
                                ...
                                <tr>
                                    <td style="font-weight: bold; text-decoration: underline;">${companyName}<br/><span style="font-size: 14px; font-weight: normal; text-decoration: none;">(Đại diện: ${creator != null ? creator.fullName : '........................'})</span></td>
...
// Recalculate total amount based on dailyRate * days - discount
    function recalculateTotal() {
        ...
        if (baseEl)
            baseEl.textContent = formatContractVND(baseAmount) + ' VND';

        var discountEl = document.getElementById('editDiscountLabel');
        if (discountEl)
            discountEl.textContent = '- ' + formatContractVND(discount) + ' VND';

        var totalEl = document.getElementById('editTotalAmountLabel');
        if (totalEl)
            totalEl.textContent = formatContractVND(total) + ' VND';
...
// --- Custom Sign Confirmation Modal JS ---
    ...
    function openSignModal(formId, title, message) {
        ...
        if (title)
            document.getElementById('signModalTitle').textContent = title;
        if (message)
            document.getElementById('signModalMessage').textContent = message;
